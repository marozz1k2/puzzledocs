...
Надёжная модель для коротких инструкций и заметок.
...
```json
{
  "text": "Составь 10 вопросов для интервью",
  "bot": "claude_3_5_haiku",
  "user": "user_123",
  "params": {
    "temperature": 0.5
  },
...
- `bot` (string, required) — идентификатор модели (`claude_3_5_haiku`).
