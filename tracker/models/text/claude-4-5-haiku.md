...
Компактная модель для кратких и аккуратных формулировок.
...
```json
{
  "prompt": "Сделай редполитику для блога",
  "bot": "claude_4_5_haiku",
  "user": "user_123",
  "params": {
    "temperature": 0.4
  },
...
- `bot` (string, required) — идентификатор модели (`claude_4_5_haiku`).
