...
Флагманская текстовая модель для сложных запросов и точной логики. В текущей конфигурации используется поколение GPT-5.5.
...
```jsonc
{
  ...
  "model": "gpt_5", // обязательно: точный ключ модели.
...
| `params` | object | Нет | Дополнительные настройки модели, если они доступны в текущей конфигурации. |
