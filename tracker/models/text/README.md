...
| --- | --- | ---: |
| `gpt_free` | GPT-5 Nano (бесплатная) | 💠10 |
...
| `gpt_terra` | Земля | 💠60 |
| `gpt_sol` | Солнце | 💠120 |
| `claude_4_5_haiku` | Claude Haiku 4.5 | 💠25 |
| `grok_4` | Grok 4 | 💠35 |
...
Сначала перечислены основные модели, затем популярные и остальные — по стоимости. В поле `model` передавайте точный ключ из первой колонки.
