...
Ускоренная версия GPT-5 Mini для массовых коротких задач. В текущей конфигурации используется поколение GPT-5.4 Mini.
...
```jsonc
{
  ...
  "model": "gpt_5_mini", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `gpt_5_mini`. |
