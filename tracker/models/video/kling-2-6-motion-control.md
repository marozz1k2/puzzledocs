...
Вариант Kling 2.6 Motion Control для генерации видео с усиленным контролем движения.
...
```jsonc
{
  ...
  "model": "kling_2_6_motion_control", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_2_6_motion_control`. |
