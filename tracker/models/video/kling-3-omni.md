...
Kling 3.0 Omni для универсальной генерации видео по текстовому описанию.
...
```jsonc
{
  ...
  "model": "kling_3_omni", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_3_omni`. |
