...
Видео-модель Kling 2.5 Turbo Pro для генерации роликов по текстовому описанию.
...
```jsonc
{
  ...
  "model": "kling_2_5_pro", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_2_5_pro`. |
