...
Kling 3.0 Omni Edit для генерации и правки видео по текстовой инструкции.
...
```jsonc
{
  ...
  "model": "kling_3_omni_edit", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_3_omni_edit`. |
