...
Видео-модель Kling 2.6 для генерации роликов по текстовому описанию.
...
```jsonc
{
  ...
  "model": "kling_2_6", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_2_6`. |
