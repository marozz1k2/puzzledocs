...
Pro-вариант Kling Omni для универсальной генерации видео по текстовому описанию.
...
```jsonc
{
  ...
  "model": "kling_omni_pro", // обязательно: точный ключ модели.
...
| `model` | string | Да | Точный ключ вызываемой модели: `kling_omni_pro`. |
