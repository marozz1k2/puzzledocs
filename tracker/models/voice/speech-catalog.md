...
| `microsoft_mai_voice_2_flash` | MAI-Voice-2 Flash | 💠0 |
| `minimax_speech_2_8_hd` | Speech 2.8 HD | 💠0 |
| `minimax_speech_2_8_turbo` | Speech 2.8 Turbo | 💠0 |
| `mistralai_voxtral_mini_tts_2603` | Voxtral Mini TTS | 💠30 |
| `qwen_qwen_audio_3_0_tts_flash` | Qwen Audio 3.0 TTS Flash | 💠0 |
| `qwen_qwen_audio_3_0_tts_plus` | Qwen Audio 3.0 TTS Plus | 💠0 |
