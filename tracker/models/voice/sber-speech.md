...
```jsonc
{
  ...
  "model": "sber_speech", // обязательно: точный ключ модели.
  ...
  "voice": "baya", // необязательно: голос для синтеза речи.
...
| `model` | string | Да | Точный ключ вызываемой модели: `sber_speech`. |
