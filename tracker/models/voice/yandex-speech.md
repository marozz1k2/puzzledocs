...
```jsonc
{
  ...
  "model": "yandex_speech", // обязательно: точный ключ модели.
  "prompt": "{{prompt}}", // обязательно: текст задачи для модели.
  "role": "[текст роли]", // необязательно: роль, стиль или ограничения для модели.
  "voice": "alena", // необязательно: голос для синтеза речи.
  "emotion": "good", // необязательно: эмоция или стиль речи.
...
| `model` | string | Да | Точный ключ вызываемой модели: `yandex_speech`. |
