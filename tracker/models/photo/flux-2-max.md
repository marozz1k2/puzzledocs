...
Максимальное качество изображения для презентационных задач.
...
```json
{
  "prompt": "Рекламный кадр часов премиум-класса",
  "bot": "flux_2_max",
  "user": "user_123",
  "params": {
    "resolution": "2k",
...
- `bot` (string, required) — идентификатор модели (`flux_2_max`).
