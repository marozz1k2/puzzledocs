...
* Временная стоимость всех музыкальных операций приведена к единому значению `💠30`.
* Ссылка из статьи «Музыкальное приложение» ведёт на публичную документацию Трекера вместо приватного репозитория.
