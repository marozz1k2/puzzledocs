...
Для реализации этого кейса необходима функция [Сценарии автоматизации](../../getting-started/biznes-funkcii/scenarii-avtomatizacii.md), которая доступна на тарифе Бизнес.
...
3. **Тариф:** Бизнес (для доступа к фоновому логированию сообщений).
...
* **AI-модель сценария.** Выберите модель, которая будет анализировать логи. Для больших объемов текста рекомендуем **Gemini 3.5 Flash** — она быстро обрабатывает длинный контекст.
...
* **Модель для переключения.** Выберите вторую модель (например, GPT-5.4 Nano  беспл.), которая подстрахует основную.
