...
3. По умолчанию работает быстрая и экономичная модель **GPT-5.4 Nano беспл**., так как для модерации не требуется сложная логика.
...
| **Параметр**        | **Условие**                                                                                                                                                           |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Стоимость проверки  | 💠1 за каждое сообщение в чате.                                                                                                                                       |
| Рекомендуемый тариф | Премиум.                                                                                                                                                              |
| Дополнительно       | При высокой активности рекомендуем заранее [пополнить баланс 💠](../../getting-started/tarify/pakety-ai-zaprosov.md).                                                  |
