...
{% hint style="info" %}
Потребуется тариф **Бизнес**. Подробнее в разделе [Тарифы.](../../getting-started/tarify/)
{% endhint %}
...
* **Рекомендуемая модель:** Gemini 3.1 Pro или GPT-5.4. У них самое большое окно контекста, что позволяет им учитывать весь объем загруженной Супер-роли при каждом ответе.

***

#### Экономика и тарифы

Реализация этого кейса доступна на тарифе Бизнес.

<table data-header-hidden><thead><tr><th width="200">Расход</th><th>Условие</th></tr></thead><tbody><tr><td>База знаний</td><td>До 50 000 символов — бесплатно. От 50 001 до 150 000 — дополнительно 💠15 к каждому ответу.</td></tr><tr><td>Списание за ответ</td><td>Стоимость выбранной модели GPT.</td></tr><tr><td>Экономия</td><td>Компоновка сообщений снижает расход баланса в 2–3 раза за счет склейки коротких фраз.</td></tr></tbody></table>
