...
* `gpt_audio_done`
* `<model_key>_done` для моделей из каталога распознавания речи, например `openai_whisper_large_v3_done`
...
* Стоимость: 💠30 (💠5 за Whisper Large + 💠25 за Gemini Pro).
...
Стоимость 💠30 окупается экономией часа времени на переслушивание записи.
