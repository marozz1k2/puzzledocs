...
{% hint style="info" %}
Эта инструкция показывает готовый сценарий на Suno. Сейчас в PuzzleAI также доступны Producer, QW Music и FlowMusic, а в Suno появились новые операции редактирования. Краткий обзор смотрите на странице [«Музыка: модели и операции»](../../info/muzykalnye-modeli-i-operacii.md), рабочие поля — в [документации Трекера](../../../tracker/models/music/README.md).
{% endhint %}
