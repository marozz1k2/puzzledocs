...
Стоимость указана рядом с моделью в формате **💠25**. Перед запуском проверьте значение в интерфейсе: для некоторых видеоопераций оно зависит от выбранных параметров.
