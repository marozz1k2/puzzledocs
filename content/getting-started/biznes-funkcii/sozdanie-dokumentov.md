...
* **Модель GPT:** выберите нейросеть (например, GPT-5.4), которая будет отвечать за генерацию текстового наполнения документа.
...
* Генерация документа списывает указанное для выбранной модели количество 💠.
* Дополнительная плата за само формирование файла (конвертацию в PDF/DOCX) на тарифе Бизнес не взимается.
