...
Выберите модель из списка подключенных в разделе GPT, которая будет проводить анализ. Рекомендуется использовать быстрые модели (например Gemini 3.5 Flash, как на примере).
...
Сбор логов входит в тариф Бизнес в рамках доступного периода хранения.
