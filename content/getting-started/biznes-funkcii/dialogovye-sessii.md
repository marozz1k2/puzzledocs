...
Функция включена в стоимость тарифа Бизнес.

* Количество сохраняемых сессий на одного пользователя не ограничено.
* Само переключение между сессиями бесплатно. 💠 списываются только при отправке сообщения модели внутри выбранной сессии.
