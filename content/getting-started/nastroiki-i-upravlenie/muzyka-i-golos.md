...
Чтобы новая песня была спета вашим голосом, создайте трек с вокалом, откройте **Тонкую настройку** → **Голос трека** и нажмите **Загрузить свой голос**. Лучше использовать чистую запись одного человека в WAV или MP3 длительностью от 10 секунд, без музыки, эха и фонового шума. Suno генерирует новое исполнение с голосовой персоной из образца, поэтому тембр будет похожим, но не обязательно полностью идентичным исходной записи.

Если важно оставить в песне именно вашу исходную вокальную запись, выберите операцию **Музыка** (**Добавить музыку**), нажмите **Записать голос** либо загрузите MP3, WAV или OGG. В этом режиме Suno добавляет инструментальное сопровождение к загруженному вокалу. Для записи прямо в Студии браузеру или WebView потребуется доступ к микрофону.
